...
public class TelemetryClient {
    ...
    public TelemetryClient() {
        ...
        this.telemetryConnection = new TelemetryConnectionImplement(this.connectionEventsSimulator);
    }

    public TelemetryClient(Random random) {
        connectionEventsSimulator = random;
        this.telemetryConnection = new TelemetryConnectionImplement(this.connectionEventsSimulator);
    }
